...
namespace LedControlToolkit
{
    ...
    /// </summary>
    public class LedControlToolkitControllerAutoConfigurator : IAutoConfigOutputController
    {
        ...
        /// <summary>
        /// This method detects and configures LedControlToolkitController output controllers automatically.
        /// </summary>
        ...
        {
            List<LedControlToolkitController> Controllers = new List<LedControlToolkitController>(Cabinet.OutputControllers.Where(OC => OC is LedControlToolkitController).Select(LW => (LedControlToolkitController)LW));
            ...
            var C = Controllers[0];
            Log.Write("Detected LedControlToolkitController Nr. {0} with name {1}".Build(C.LedWizNumber, C.Name));
            ...
            if (ledWizEquivalents.Length == 0) {
                ...
                //Override Ledstrips with LedControlToolkitController name
    ...
    public class LedControlToolkitController : OutputControllerCompleteBase
    {
